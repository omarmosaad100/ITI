...
void Node::add_node()
{
    ...
    {
        if (pstart == plast) ///one element
        {
            if (newNode-> data.Age < pstart-> data.Age)
            {
        ...
        else
        {
            ...
            while (tmp -> data.Age < newNode -> data.Age && tmp->pnext != NULL)
                tmp = tmp-> pnext;
            ...
            else if (tmp == plast && plast -> data.Age < newNode ->data.Age)
            {
                plast -> pnext = newNode;
                newNode -> pprev = plast;
                plast = newNode;
